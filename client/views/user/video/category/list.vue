...
<script>
  ...
  export default {
    ...
    computed: {
      listApi () {
        return `${this.API.url}/video/categorylist${this.API.suf}`
      },
      editApi () {
        return `${this.API.url}/video/categorysave${this.API.suf}`
      },
      delApi () {
        return `${this.API.url}/video/categorydelete${this.API.suf}`
      },
    },
