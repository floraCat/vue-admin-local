...
<script>
  ...
  export default {
    ...
    computed: {
      listApi () {
        return `${this.API.url}/mall/list${this.API.suf}`
      },
      editApi () {
        return `${this.API.url}/mall/save${this.API.suf}`
      },
      delApi () {
        return `${this.API.url}/mall/delete${this.API.suf}`
      },
      fieldItemsApi () {
        return `${this.API.url}/mall/arealist${this.API.suf}`
      }
    },
