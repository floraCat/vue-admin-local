...
<script>
  ...
  export default {
    ...
    computed: {
      listApi () {
        return `${this.API.url}/role/list${this.API.suf}`
      },
      editApi () {
        return `${this.API.url}/role/save${this.API.suf}`
      },
      delApi () {
        return `${this.API.url}/role/delete${this.API.suf}`
      },
      apiBindGet () {
        return `${this.API.url}/role/getmenusbyroleid${this.API.suf}`
      },
      apiBindPost () {
        return `${this.API.url}/role/bindmenu${this.API.suf}`
      },
    },
