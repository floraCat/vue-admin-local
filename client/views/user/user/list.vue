...
<script>
  ...
  export default {
    ...
    computed: {
      listApi () {
        return `${this.API.url}/user/list${this.API.suf}`
      },
      editApi () {
        return `${this.API.url}/user/save${this.API.suf}`
      },
      delApi () {
        return `${this.API.url}/user/delete${this.API.suf}`
      },
      apiBindGet () {
        return `${this.API.url}/user/get${this.API.suf}`
      },
      apiBindPost () {
        return `${this.API.url}/user/bind_role${this.API.suf}`
      },
    },
