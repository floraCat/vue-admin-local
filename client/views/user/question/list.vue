...
<script>
  ...
  export default {
    ...
    computed: {
      listApi () {
        return `${this.API.url}/dic/questionlist${this.API.suf}`
      },
      // editApi () {
      //   return `${this.API.url}/customerorder/save${this.API.suf}`
      // },
      // delApi () {
      //   return `${this.API.url}/customerorder/delete${this.API.suf}`
      // },
    },
